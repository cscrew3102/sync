...
class Query{
	...
	*/
	...
	public function join($sync_array = '',$sync__str = array()){
	...
	*/
	...
	public static function find_data($field='*',$tableName='',$where='',$order=''){
			include_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Select.php';
			$wheres='';
			$paging='';
			if(is_array($field)){
	...
	public static function msg($tipe='1',$data){
		if($tipe=='1'){
				echo'<div class="alert alert-success alert-dismissable">
						<button type="button" data-dismiss="alert" aria-hidden="true" class="close">×</button>
						<strong>Informasi!</strong> '.$data.'</div>';
		}elseif($tipe=='2'){
